...
write.csv(new_md, "~/Desktop/mouse_studies/Heatmaps/File_processing/md_new.csv",row.names = TRUE)
...
#scaling
Imputed <- read_csv("~/Desktop/mouse_studies/Heatmaps/File_processing/Imputed_QuantTable_filled_with_126_CutOff_Used_0.3.csv")
